...
public class PackUtils {
    ...
    public static void main(String[] args) {
        List<Class<?>> classList = PackUtils.getClassList(ParentContextApplicationContextInitializer.class.getPackage().getName(), true);
        System.out.println(classList);
    }

    @Valid
    public static List<Class<?>> getClassList(@NotBlank String packageName, boolean isRecursive) {
     ...
     */
    @Valid
    public static List<Class<?>> getClassListByAnnotation(@NotBlank String packageName, @NotNull Class<? extends Annotation> annotationClass) {
